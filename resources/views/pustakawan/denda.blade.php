                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
                        <span class="text-sm text-gray-600 order-2 sm:order-1">
                            Menampilkan <span class="font-semibold text-gray-800">{{ $dataDenda->firstItem() }}</span>
                            sampai <span class="font-semibold text-gray-800">{{ $dataDenda->lastItem() }}</span>
                            dari <span class="font-semibold text-gray-800">{{ $dataDenda->total() }}</span> hasil
                        </span>
                        ...
                        <div class="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-3 order-1 sm:order-2">
                            <form action="{{ route('pustakawan.denda.index') }}" method="GET" class="flex items-center space-x-2">
                            ...
                            <div class="flex items-center space-x-1 bg-gray-100 px-2 py-1 rounded-lg shadow-inner">
                                ...
                                @if ($dataDenda->hasMorePages())
                                    <a href="{{ $dataDenda->nextPageUrl() }}"
