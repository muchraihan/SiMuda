...
<head>
    ...
    <title>Daftar - SiMuda Perpustakaan</title>
...
<body class="font-sans antialiased bg-white">
    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex w-1/2 bg-green-900 items-center justify-center relative overflow-hidden">
            <!-- Gambar Background (Sama dengan Login agar konsisten) -->
            ...
            <div class="relative z-10 text-center text-white p-12 max-w-lg">
                ...
                <h1 class="text-5xl font-extrabold tracking-tight mb-4 drop-shadow-md">Bergabunglah</h1>
                <p class="text-xl font-medium text-green-100 leading-relaxed">
                    Jadilah bagian dari komunitas literasi digital SMP Muhammadiyah 2 Kartasura.
                </p>
            ...
            <div class="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-xl lg:shadow-none border border-gray-100 lg:border-none">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                        Lengkapi data diri Anda untuk mulai meminjam buku.
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="mt-8 space-y-5">
                    ...
                    <!-- Confirm Password -->
                    <div class="space-y-1" x-data="{ showConfirmPassword: false }">
                        ...
                        <div class="relative rounded-md shadow-sm">
                            ...
                            <input id="password_confirmation" name="password_confirmation" :type="showConfirmPassword ? 'text' : 'password'" autocomplete="new-password" required
                                   class="block w-full pl-10 pr-10 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 sm:text-sm transition duration-200 placeholder-gray-400"
                    ...
                    <div class="pt-2">
                        <button type="submit"
                            ...
                            <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                                <svg class="h-5 w-5 text-green-500 group-hover:text-green-400 transition duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
