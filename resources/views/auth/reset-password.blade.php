...
<head>
    ...
    <title>Reset Kata Sandi - SiMuda Perpustakaan</title>
        ...
        <div class="w-full lg:w-1/2 h-full overflow-y-auto bg-gray-50 lg:bg-white">
            ...
            <div class="min-h-full flex items-center justify-center p-8 sm:p-12">
                ...
                <div class="text-center lg:text-left">
                    ...
                    <h2 class="text-3xl font-bold text-gray-900 tracking-tight">Atur Ulang Kata Sandi</h2>
                    <p class="mt-2 text-sm text-gray-500">
                        Masukkan alamat email dan kata sandi baru Anda.
                    </p>
                </div>
