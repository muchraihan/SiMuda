                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="nomor_whatsapp" oninput="this.value = this.value.replace(/[^0-9]/g, '')" inputmode="numeric"  pattern="[0-9]*" value="{{ old('nomor_whatsapp', $siswa->nomor_whatsapp) }}" required
